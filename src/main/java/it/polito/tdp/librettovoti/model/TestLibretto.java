...
public class TestLibretto {
	...
	public static void main(String[] args) {
		...
		System.out.println(venticinque); //mi sono obbligato a usare nel test un oggetto di basso livello (List) invece che Libretto (oggetto di alto livello)

		Libretto librettoventicinque = libretto.votiUguali(25);
	
		System.out.println(librettoventicinque); //il libretto sa gia' come stamparsi, tramite i vari metodi toString() che abbiamo definito
